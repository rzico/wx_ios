...
- (void)initMenuScrollView
{
    if(self.menuView==nil){
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 3)];
        line.backgroundColor = [UIColor colorWithRed:0xcc/255.0 green:0xcc/255.0 blue:0xcc/255.0 alpha:1];
        menuScroll.backgroundColor = [UIColor colorWithRed:0xee/255.0 green:0xee/255.0 blue:0xee/255.0 alpha:0.8];
        [menuScroll addSubview:line];
...
{
    if ([sender.view.toolInfo.toolName isEqualToString:@"CLChangeImage"]){
        ...
        imagePickerVc.naviBgColor = [UIColor colorWithRed:0x99/255.0 green:0xcc/255.0 blue:0xff/255.0 alpha:1];
        ...
        imagePickerVc.didFinishPickingPhotosHandle = ^(NSArray<UIImage *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
            [[TZImageManager manager] getOriginalPhotoWithAsset:[assets firstObject] completion:^(UIImage *photo, NSDictionary *info) {
                _originalImage = [[photos firstObject] deepCopy];
                [self refreshImageView];
            }];
        };
