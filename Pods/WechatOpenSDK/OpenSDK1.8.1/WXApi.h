...
//更改WXLogLevel为WELogLevel by CJ
-(void) onLog:(NSString*)log logLevel:(WELogLevel)level;
 ...
 */
//更改WXLogLevel为WELogLevel by CJ
+(void) startLogByLevel:(WELogLevel)level logBlock:(WXLogBolock)logBlock;
 ...
 */
//更改WXLogLevel为WELogLevel by CJ
+ (void)startLogByLevel:(WELogLevel)level logDelegate:(id<WXApiLogDelegate>)logDelegate;
