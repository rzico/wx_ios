...
#define ZSSRGB(r,g,b) [UIColor colorWithRed:r/255.0f green:g/255.0f blue:b/255.0f alpha:1.0f]
...
- (NSArray *)solverTokens
{
    NSArray *solverTokens =  @[
                               [CYRToken tokenWithName:@"html_tags"
                                            expression:@"(<\\/?[a-z][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : ZSSRGB(25, 0, 151)}],
                               [CYRToken tokenWithName:@"a_tag"
                                            expression:@"(<\\/?[a][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : ZSSRGB(24, 104, 10)}],
                               [CYRToken tokenWithName:@"img_tag"
                                            expression:@"(<\\/?[img][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : ZSSRGB(148, 0, 151)}],
                               ...
                               [CYRToken tokenWithName:@"comment"
                                            expression:@"<!--(.*?)-->"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : ZSSRGB(31, 131, 0),
                                                         NSFontAttributeName : self.italicFont
                                                         }],
                               [CYRToken tokenWithName:@"attributes"
                                            expression:@"(?<==)('|\").*?\\1(?=.*?>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : ZSSRGB(0, 12, 255)
                                                         }]
                               ];
