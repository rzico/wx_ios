...
- (id)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor colorWithHex:0xf4f4f6];
        self.layer.borderWidth = 0.5;
        self.layer.borderColor = [UIColor colorWithHex:0xdbdbdd].CGColor;
...
- (void)configInputContainerView {
    ...
    [_switchButton setImage:[UIImage imageNamed:@"chat_setmode_voice_btn_normal"] forState:UIControlStateNormal];
    ...
    _inputTextView.layer.borderColor = [UIColor colorWithHex:0xA4A4A4].CGColor;
...
//        }
        labelSize = [text length] > 0 ? [text sizeWithFont:[UIFont systemFontOfSize:fontSize] constrainedToSize:maxSize lineBreakMode:NSLineBreakByTruncatingTail] : CGSizeZero;
