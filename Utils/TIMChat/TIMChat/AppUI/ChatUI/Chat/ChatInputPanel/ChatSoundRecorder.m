...
- (void)showRecordView
{
    UIViewController *topViewController = [SharedAppDelegate topViewController];
...
{
    //禁用导航栏上右侧按钮
    UIBarButtonItem *rightItem = [SharedAppDelegate topViewController].navigationItem.rightBarButtonItem;
