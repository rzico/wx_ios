...
//    [_file setTitle:@"文件" forState:UIControlStateNormal];
    [_file setTitle:@"" forState:UIControlStateNormal];
//
    [_file setImage:[UIImage new] forState:UIControlStateNormal];
...
//    [_video setTitle:@"小视频" forState:UIControlStateNormal];
    [_video setTitle:@"" forState:UIControlStateNormal];
    [_video setImage:[UIImage new] forState:UIControlStateNormal];
