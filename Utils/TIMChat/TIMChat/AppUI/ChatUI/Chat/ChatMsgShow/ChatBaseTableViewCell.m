...
- (void)onClickUserIcon
{
    ...
    if (sender)
    {
        ...
        NSDictionary *dic = [[NSDictionary alloc] initWithObjectsAndKeys:vc,@"viewController",@"返回",@"backTitle", nil];
        NSNotification *notification = [NSNotification notificationWithName:@"TIMChatPushViewControllerWithBackTitle" object:nil userInfo:dic];
