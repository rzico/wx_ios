...
//        [[IMAAppDelegate sharedAppDelegate] popToRootViewController];
        NSNotification *notification = [NSNotification notificationWithName:@"TIMChatNavPopToRootViewController" object:nil userInfo:nil];
...
//        __weak typeof(self) ws = self;
        ...
        UIAlertView *alert = [UIAlertView bk_showAlertViewWithTitle:@"下线通知" message:@"您的帐号于另一台手机上登录。" cancelButtonTitle:@"重新登录" otherButtonTitles:nil handler:^(UIAlertView *alertView, NSInteger buttonIndex) {
            [self offlineLogin];
            // 重新登录
...
- (void)onReConnFailed:(int)code err:(NSString*)err
{
    ...
    kIsAlertingForceOffline = YES;
//    __weak typeof(self) ws = self;
    UIAlertView *alert = [UIAlertView bk_showAlertViewWithTitle:@"下线通知" message:@"断线重连失败。" cancelButtonTitle:@"重新登录" otherButtonTitles:nil handler:^(UIAlertView *alertView, NSInteger buttonIndex) {
        [self offlineLogin];
        // 重新登录
        [SharedAppDelegate logOut:nil];
        kIsAlertingForceOffline = NO;
